...
const data: GraphData = {
  nodes: [
    ...
    { id: "Region", nodeId: "l2-Airport-Region", group: "Subcategory", value: 500, cluster: "l1-Airport" },
    { id: "Country", nodeId: "l2-Airport-Country", group: "Subcategory", value: 500, cluster: "l1-Airport" },
    { id: "Aircraft", nodeId: "l1-Aircraft", group: "Category", value: 1200, cluster: "l1-Aircraft" },
    { id: "Aircraft Type", nodeId: "l2-Aircraft-Aircraft Type", group: "Subcategory", value: 400, cluster: "l1-Aircraft" },
    { id: "Seating Plan", nodeId: "l2-Aircraft-Seating Plan", group: "Subcategory", value: 400, cluster: "l1-Aircraft" },
    { id: "Registration", nodeId: "l2-Aircraft-Registration", group: "Subcategory", value: 400, cluster: "l1-Aircraft" },
    { id: "Bluechip", nodeId: "l1-Bluechip", group: "Category", value: 300, cluster: "l1-Bluechip" },
    { id: "Cargo", nodeId: "l1-Cargo", group: "Category", value: 800, cluster: "l1-Cargo" },
    { id: "Category", nodeId: "l2-Cargo-Category", group: "Subcategory", value: 200, cluster: "l1-Cargo" },
    { id: "Freighter Tonnage/Volumes", nodeId: "l2-Cargo-Freighter Tonnage/Volumes", group: "Subcategory", value: 200, cluster: "l1-Cargo" },
    { id: "Freighters", nodeId: "l2-Cargo-Freighters", group: "Subcategory", value: 200, cluster: "l1-Cargo" },
    { id: "Cargo Agent Performances", nodeId: "l2-Cargo-Cargo Agent Performances", group: "Subcategory", value: 200, cluster: "l1-Cargo" },
    { id: "Crew", nodeId: "l1-Crew", group: "Category", value: 500, cluster: "l1-Crew" },
    ...
    { id: "Customer", nodeId: "l1-Customer", group: "Category", value: 2000, cluster: "l1-Customer" },
    ...
    { id: "Hotel Bookings", nodeId: "l2-Customer-Hotel Bookings", group: "Subcategory", value: 200, cluster: "l1-Customer" },
    { id: "Ancillary Preferences", nodeId: "l2-Customer-Ancillary Preferences", group: "Subcategory", value: 200, cluster: "l1-Customer" },
    { id: "Customer Experience", nodeId: "l2-Customer-Customer Experience", group: "Subcategory", value: 200, cluster: "l1-Customer" },
    { id: "Booking Channels", nodeId: "l2-Customer-Booking Channels", group: "Subcategory", value: 200, cluster: "l1-Customer" },
    { id: "Employee", nodeId: "l1-Employee", group: "Category", value: 1000, cluster: "l1-Employee" },
    { id: "Employee Profile", nodeId: "l2-Employee-Profile", group: "Subcategory", value: 200, cluster: "l1-Employee" },
    { id: "Headcount", nodeId: "l2-Employee-Headcount", group: "Subcategory", value: 200, cluster: "l1-Employee" },
    { id: "Attrition", nodeId: "l2-Employee-Attrition", group: "Subcategory", value: 200, cluster: "l1-Employee" },
    { id: "Diversity", nodeId: "l2-Employee-Diversity", group: "Subcategory", value: 200, cluster: "l1-Employee" },
    { id: "Span of Control", nodeId: "l2-Employee-Span of Control", group: "Subcategory", value: 200, cluster: "l1-Employee" },
    { id: "Flight", nodeId: "l1-Flight", group: "Category", value: 900, cluster: "l1-Flight" },
    { id: "Schedules", nodeId: "l2-Flight-Schedules", group: "Subcategory", value: 225, cluster: "l1-Flight" },
    { id: "Sectors", nodeId: "l2-Flight-Sectors", group: "Subcategory", value: 225, cluster: "l1-Flight" },
    { id: "Codeshare", nodeId: "l2-Flight-Codeshare", group: "Subcategory", value: 225, cluster: "l1-Flight" },
    { id: "Network", nodeId: "l2-Flight-Network", group: "Subcategory", value: 225, cluster: "l1-Flight" },
    { id: "Sales", nodeId: "l1-Sales", group: "Category", value: 1500, cluster: "l1-Sales" },
    { id: "Revenue", nodeId: "l2-Sales-Revenue", group: "Subcategory", value: 200, cluster: "l1-Sales" },
    { id: "Routes", nodeId: "l2-Sales-Routes", group: "Subcategory", value: 200, cluster: "l1-Sales" },
    { id: "Product Class", nodeId: "l2-Sales-Product Class", group: "Subcategory", value: 200, cluster: "l1-Sales" },
    { id: "Connections", nodeId: "l2-Sales-Connections", group: "Subcategory", value: 200, cluster: "l1-Sales" },
    { id: "Cancellations", nodeId: "l2-Sales-Cancellations", group: "Subcategory", value: 150, cluster: "l1-Sales" },
    { id: "Channel", nodeId: "l2-Sales-Channel", group: "Subcategory", value: 150, cluster: "l1-Sales" },
    { id: "Baggage Details", nodeId: "l2-Sales-Baggage Details", group: "Subcategory", value: 200, cluster: "l1-Sales" },
    { id: "Sales Agent Performances", nodeId: "l2-Sales-Sales Agent Performances", group: "Subcategory", value: 200, cluster: "l1-Sales" }
  ],
  links: [
    { source: "Data Assets", target: "Airport", value: 2 },
    { source: "Airport", target: "Region", value: 2 },
    { source: "Airport", target: "Country", value: 2 },
    ...
    { source: "Customer", target: "Customer Experience", value: 2 },
